...
AppMenuWidget::AppMenuWidget()
{
	...
	css +=		"border: none;";
	css +=		"image: url(";
	css +=		KStandardDirs::locate("data", "kbruch/pics/freestyle.png");
	css +=		");";
	css +=	"}";
	css += "QPushButton#m_Learning {";
	css +=		"border: none;";
	css +=		"image: url(";
	css +=		KStandardDirs::locate("data", "kbruch/pics/learning_1.png");
	css +=		");";
	css +=	"}";
	css += "QPushButton#m_Learning:hover {";
	css +=		"border: none;";
	css +=		"image: url(";
	css +=		KStandardDirs::locate("data", "kbruch/pics/learning.png");
	css +=		");";
	css +=	"}";
