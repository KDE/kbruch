...
int main(int argc, char * argv[])
{
	...
	/*task aufgabe;
	aufgabe.add_ratio(11, 20);
	aufgabe.add_ratio(4, 5);
	aufgabe.add_ratio(11, 10);
	aufgabe.add_ratio(4, 5);
	aufgabe.add_ratio(3, 5);
	aufgabe.add_operation(SUB);
	aufgabe.add_operation(SUB);
	aufgabe.add_operation(SUB);
	aufgabe.add_operation(SUB);
	aufgabe.display_task();
	aufgabe.solve().display();
*/
/*	task aufgabe, aufgabe2, aufgabe3, aufgabe4, aufgabe5;

	aufgabe.add_ratio(1, 3);
	aufgabe.add_ratio(2, 5);
	aufgabe.add_ratio(3, 8);
	aufgabe.add_ratio(7, 4);
	aufgabe.add_ratio(9, 2);
	aufgabe.add_operation(ADD);
	aufgabe.add_operation(MUL);
	aufgabe.add_operation(DIV);
	aufgabe.add_operation(SUB);
	aufgabe.display_task();
	aufgabe.solve().display();

	aufgabe2.add_ratio(1, 3);
	aufgabe2.add_ratio(2, 7);
	aufgabe2.add_operation(DIV);
	aufgabe2.display_task();
	aufgabe2.solve().display();

	aufgabe3.add_ratio(1, 3);
	aufgabe3.add_ratio(2, 7);
	aufgabe3.add_operation(SUB);
	aufgabe3.display_task();
	aufgabe3.solve().display();

	cin.get();
	system("clear");
	aufgabe4.add_ratio(1, 3);
	aufgabe4.add_ratio(2, 7);
	aufgabe4.add_ratio(9, 4);
	aufgabe4.add_operation(MUL);
	aufgabe4.add_operation(SUB);
	aufgabe4.display_task();
	aufgabe4.solve().display();

	aufgabe5.add_ratio(1, 3);
	aufgabe5.add_ratio(2, 7);
	aufgabe5.add_ratio(9, 4);
	aufgabe5.add_operation(ADD);
	aufgabe5.add_operation(DIV);
	aufgabe5.display_task();
	aufgabe5.solve().display();
*/
//	primzahl number1, number2;

//	cout << "Zahl: " << number1.isPrimeNumber(101) << endl;
//	number2.display_all();
//	ratio a(1, 2);
//	ratio b;
//	b.set_zaehler(2);
...
//	task aufgabe(20, 3, 1, 1);
//	aufgabe.set_ratio_n(0, 1, 2);
//	aufgabe.set_ratio_n(1, 2, 3);
//	aufgabe.set_ratio_n(2, a);
//	aufgabe.set_op_n(0, ADD);
//	aufgabe.set_op_n(0, SUB);
//	c = aufgabe.solve();
//	c.display();
//	cin.get();
/*	primzahl * a = new primzahl;
	a->display_all();
	cout << a->get_next() << endl;
	cout << a->get_next() << endl;
	delete a;
	primzahl * b = new primzahl;
	b->display_all();
	delete b;*/
/*	cout << a.get_next() << endl;
	cout << a.get_next() << endl;
	a.display_all();*/
/*	cout << a.isPrimeNumber(101) << endl;
	a.display_all();
*/
/*	return 0;*/
}
